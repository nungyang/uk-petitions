...
async def main():
    ...
    # Restricting to petitions closed in the last 12 months
    ...
    upload_to_s3(all_petitions_list, 'dynamic data/all_petitions_list.csv', s3_client, bucket)
    upload_to_s3(all_petitions_counts, 'dynamic data/all_petitions_counts.csv', s3_client, bucket)
